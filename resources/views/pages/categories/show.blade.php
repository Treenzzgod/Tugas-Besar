...
<section class="container-fluid py-5" id="trending">
    <div class="container py-3">
        ...
        <div class="d-flex justify-content-center">
            <img src="assets/img/trending.jpg" class="card-img-top img-fluid img-card" alt="...">
        </div>
        <div class="card-body">
        ...
        <div class="loadmore-frame">
            @foreach ($posts as $post)
                <div class="card mb-3 blogBox moreBox" style="height: 200px; width: auto;">
                    <div class="row g-0">
                        <div class="col-md-3">
                            <img src="assets/img/img01.jpg" class="img-fluid rounded-start d-none d-lg-block" alt="..."
